...
/**
 * 
 * @author Yammanuru Rajanikantha
 *
 */

@Table(value = "stock_quotes")
public class MarketQuote implements Serializable {
	private static final long serialVersionUID = 1L;
	@PrimaryKey
	private MarketQuoteKey marketQuoteKey;
	private String ask;
	...
	private String changeInPercentChange;
	...
	public String getChangeInPercentChange() {
		return changeInPercentChange;
	}
	public void setChangeInPercentChange(String changeInPercentChange) {
		this.changeInPercentChange = changeInPercentChange;
	}
	...
	public void setPercentChangeFromYearHigh(String percebtChangeFromYearHigh) {
		this.percentChangeFromYearHigh = percebtChangeFromYearHigh;
	}
	...
	public MarketQuoteKey getMarketQuoteKey() {
		return marketQuoteKey;
	}
	public void setMarketQuoteKey(MarketQuoteKey marketQuoteKey) {
		this.marketQuoteKey = marketQuoteKey;
	}
